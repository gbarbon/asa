...
\author{ Gianluca Barbon\inst{1}  \and Agostino Cortesi\inst{1} \and Enrico Steffinlongo\inst{1} \and  \\ Pietro Ferrara\inst{2} 
%\and Marco Pistoia\inst{2} \and Omer Tripp\inst{2}
}
