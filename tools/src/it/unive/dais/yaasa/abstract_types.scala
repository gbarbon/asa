...
object abstract_types {
  ...
  object Intervals {
    ...
    implicit def latticeBoolAt(l: Interval): Lattice[Interval] = new Lattice[Interval] { //TODO: doublecheck
      ...
      def meet(r: Interval): Interval =
        throw new Unexpected("Meet of interval not implemented...") //FIXME: implement this using factory for bottom interval
      //if (this <== r) l else r
      /*(l, r) match {
